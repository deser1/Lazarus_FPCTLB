...
2. Zanim wciśniesz **F9** (Uruchom), musisz podać argumenty. W górnym menu wybierz **Uruchom** -> **Parametry uruchomieniowe...** (*Run* -> *Run Parameters...*).
3. W polu **Parametry linii poleceń** (*Command line parameters*) wpisz np.: 
...
1. W górnym menu Lazarusa wybierz **Narzędzia** -> **Konfiguruj Narzędzia Zewnętrzne...** (*Tools* -> *Configure External Tools...*).
2. Kliknij **Dodaj** (*Add*).
...
4. Zaznacz opcję: **Skanuj wyjście w poszukiwaniu błędów FPC** (*Scan output for FPC errors*), aby komunikaty z naszego parsera były widoczne w oknie wiadomości Lazarusa.
5. Kliknij **OK**.
